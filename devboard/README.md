...
Project management dashboard built with Angular 21 and the `retro-ui` design system.
...
- Domain components (`project-card`, `project-detail-header`, `task-row`, `task-filter-bar`) live inside `src/app/features/projects/ui/`.
